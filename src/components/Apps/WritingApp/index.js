	...
	render = () => {
		...
		return (
			<AppSite>
				...
				<SocialMedia premium ban={this.state.banTime} lang={this.state.languageOrder} langChanges={this.state.langChanges} changeLanguage={this.changeLanguage} answers={this.state.answers} hint={this.hint} />
			</AppSite>
		);
	}
}
